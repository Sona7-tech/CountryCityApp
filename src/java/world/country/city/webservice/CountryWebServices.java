...
import world.country.city.impl.CountryDaoImpl;
...
import world.country.city.service.CountryService;
import world.country.city.service.CountryServiceImpl;
...
public class CountryWebServices {
    ...
    CountryService countryService = new CountryServiceImpl(countryDao,loginCompanyDao);
    @GET
    @Path("/test")
    @Produces("text/html")
    public String getGreeting() {
        return "<html><body><h1>Hello City!</h1></body></html>";
    }
    
    @POST
    @Path("/getCountryList")
    @Produces(MediaType.APPLICATION_JSON)
    public RespCountryList getCountryList(ReqUser reqUser) throws Exception{
     
        return countryService.getCountryList(reqUser);
    }
